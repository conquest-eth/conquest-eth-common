...
//     });
//     it('works', () => {
//       const planet = defaultPlanet({stats: defaultConfig.stats, world: {externalUpKeepDuration: days(3)}});
//       peek(planet, days(2));
//       send(planet, days(1), 259200);
//       peek(planet, days(0.5));
//       peek(planet, days(0.5));
...
function defaultPlanet(config = defaultConfig): FakePlanet {
  const planet: FakePlanet = {
    ...
    world: {
      externalUpKeepDuration: config.world.externalUpKeepDuration,
      externalUpkeepDownRate: config.world.externalUpKeepDuration,
    },
    externalUpkeep: 0,
